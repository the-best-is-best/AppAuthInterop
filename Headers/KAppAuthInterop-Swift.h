...
#ifndef APPAUTHINTEROP_SWIFT_H
#define APPAUTHINTEROP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AppAuthInterop",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
SWIFT_CLASS("_TtC14AppAuthInterop10AuthTokens")
...
@class KOpenIdConfig;
SWIFT_CLASS("_TtC14AppAuthInterop12KAuthManager")
...
- (void)loginWithOpenId:(KOpenIdConfig * _Nonnull)openId :(void (^ _Nonnull)(AuthTokens * _Nullable, NSString * _Nullable))completion;
- (void)logoutWithOpenId:(KOpenIdConfig * _Nonnull)openId :(void (^ _Nonnull)(BOOL, NSString * _Nullable))completion;
...
SWIFT_CLASS("_TtC14AppAuthInterop13KOpenIdConfig")
